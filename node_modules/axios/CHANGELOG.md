...
- Fix Keep defaults local to cInstance ([#385](https://github.com/axios/axios/issues/385))
...
- Fix Default method for an cInstance always overwritten by get
...
- Adding function signature in AxioscInstance interface so AxioscInstance can be invoked ([#1192](https://github.com/axios/axios/pull/1192), [#1254](https://github.com/axios/axios/pull/1254))
- Allowing maxContentLength to pass through to redirected calls as maxBodyLength in follow-redirects config ([#1287](https://github.com/axios/axios/pull/1287))
- Fixing configuration when using an cInstance - method can now be set ([#1342](https://github.com/axios/axios/pull/1342))
...
- Fixing issue with custom cInstances and global defaults ([#443](https://github.com/axios/axios/issues/443))
...
- Fixing custom cInstance defaults ([#341](https://github.com/axios/axios/issues/341))
- Fixing cInstances created from `axios.create` to have same API as default axios ([#217](https://github.com/axios/axios/issues/217))
...
- Adding request cInstance to response ([#200](https://github.com/axios/axios/pull/200))
...
- Adding support for creating cInstances of axios ([#123](https://github.com/axios/axios/pull/123))
