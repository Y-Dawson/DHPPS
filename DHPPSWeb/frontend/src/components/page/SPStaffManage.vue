                    ...
                    <!-- 列表 -->
                        <div class="list">
                            <table class="layui-table" lay-size="sm" lay-even lay-skin="row">
                                ...
                                <thead>
                                <tr>
                                    <th style="width: 10%;text-align: center;">员工ID</th>
                                    <th style="width: 10%;text-align: center;">员工昵称</th>
                                    <th style="width: 10%;text-align: center;" lay-data="{sort:true}">手机号</th>
                                    <th style="width: 20%;text-align: center;">邮箱</th>
                                    <th style="width: 10%;text-align: center;">住址</th>
