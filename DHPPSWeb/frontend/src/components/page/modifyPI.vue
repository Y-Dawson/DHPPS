              ...
              <div class="list">
                <el-form :model="ruleForm" :rules="rules" :label-position="labelPosition" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                  <div class="demo-fit" style="text-align:center;">
                    <div class="block">
                      <el-avatar shape="circle" :size="70" :fit="fill" :src="url"></el-avatar>
                    </div>
                  </div>
                  <el-form-item label="昵称" prop="name">
                    <el-input size="small" v-model="ruleForm.name" clearable id="inputname"></el-input>
                  </el-form-item>
                  <el-form-item label="手机号" prop="phone">
                    <el-input size="small" v-model="ruleForm.phone" clearable id="inputphone"></el-input>
                  </el-form-item>
                  <el-form-item label="性别" prop="sex">
                    <el-radio-group  v-model="ruleForm.radio" @change="changeHandler" id="inputsex">
                  ...
                  <el-form-item label="邮箱" prop="email">
                    <el-input size="small" v-model="ruleForm.email" clearable id="inputmail"></el-input>
                  </el-form-item>
                  <el-form-item label="住址" prop="addr">
                    <el-input size="small" v-model="ruleForm.addr" clearable id="inputaddr"></el-input>
                  </el-form-item>
                  <el-form-item>
      ...
      var checkanme= (rule, value, callback) => {
        ...
        setTimeout(() => {
          ...
          if (value == '' || !reg.test(value)) {
            callback(new Error('昵称限1-20个字符，支持中英文、数字、减号或下划线'));
          }
          else{
            callback();
          }
