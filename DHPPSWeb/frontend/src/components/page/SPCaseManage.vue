                    ...
                    <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                        <li class="layui-nav-item layui-nav-itemed">
                            ...
                            <dl class="layui-nav-child">
                                <dd><router-link :to="{path:'/SPUserManage',query:{uI:this.userId}}">信息管理</router-link></dd>
                            </dl>
                        ...
                        <div class="list">
                            ...
                            <tbody>
                                <tr v-for="item in content" :key="item.userid">
                                    ...
                                    <td>
                                        <button class="buttonA"><router-link :to="{path:'/SPCaseEdit',query:{uI:item.userid,userId:userId}}">案例编辑</router-link></button>
